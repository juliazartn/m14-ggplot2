...
ggplot(data = diamonds.sample) + geom_point(mapping = aes(x = carat, y = price, alpha = carat))
...
ggplot(data = diamonds.sample) + geom_point(mapping = aes(x = carat, y = price, color = price))
